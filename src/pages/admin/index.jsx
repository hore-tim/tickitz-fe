...
export default function Admin() {
  ...
  return (
    <>
      <Navbar />
      <main className="px-[1.8rem] lg:px-[4.8rem] py-14 select-none bg-[#F5F6F8]">
        <section className="w-full flex flex-col lg:flex-row gap-4 px-0lg:px-10">
          <section className="w-full lg:w-[70%]  flex flex-col">
            <h1 className="font-bold text-xl mb-6">Movie Description</h1>
            <div className="w-full flex flex-col bg-white rounded-lg px-5 pt-14 pb-20 gap-5">
              <div className="flex flex-col lg:flex-row gap-3 justify-center items-center lg:justify-normal lg:items-start">
