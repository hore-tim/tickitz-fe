					...
					<section className="bg-[#F5F6F8]">
						<div className="py-10 md:px-20 px-5 flex flex-col gap-y-10">
							<div className="flex items-center justify-between">
								...
								<div>
									<Link href={"/movies"} className="font-bold text-tickitz-primary">view all</Link>
								</div>
							</div>
							<div className="relative">
								<div className="carousel pb-38 gap-x-5">
									{movies.map((movie, index) => {
										return (
											<div key={index} className="group carousel-item w-[202.2px] cursor-pointer">
												<div className="flex flex-col gap-y-7 bg-white/20 group-hover:bg-white group-hover:absolute border-2 border-white rounded-md p-5">
													<figure>
														<Image alt="movie-poster" src={movie.image} width={159} height={224} />
													</figure>
